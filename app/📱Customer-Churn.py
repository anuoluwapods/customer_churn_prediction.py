...
header = '<p style="font-family:sans-serif; color:White;">This Web Application can predict if a customer will stay or churn a telecommunication service.</p>'
col1.markdown(header, unsafe_allow_html=True)
subheader = '<p style="font-family:sans-serif; color:White;">We created this webapp to help reduce the high rate of customer churn in telecommunication industries.</p>'
